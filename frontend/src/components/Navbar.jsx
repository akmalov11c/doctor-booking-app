      ...
      <div className="flex items-center gap-4">
        {token ? (
          <div className="flex items-center gap-2 cursor-pointer relative">
            ...
            <img onClick={() => setShowDropdown((prev) => !prev)} className="w-8 rounded-full" src={userData.image} alt="" />
            <img onClick={() => setShowDropdown((prev) => !prev)} className="w-2.5" src={assets.dropdown_icon} alt="" />
            {showDropdown && (
        ...
        >
          <div className="flex items-center justify-between px-5 py-6">
            <p className="text-3xl font-bold text-primary">BDoctor</p>
            <img
              className="w-7"
